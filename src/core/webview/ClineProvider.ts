    ...
    implements vscode.WebviewViewProvider, TelemetryPropertiesProvider, TaskProviderLike
{
    ...
    */
    ...
    async dispose() {
        ...
        // kilocode_change: Dispose code index subscription to prevent memory leaks
        if (this.codeIndexStatusSubscription) {
            this.codeIndexStatusSubscription.dispose()
            this.codeIndexStatusSubscription = undefined
            this.log("Disposed code index subscription")
        }
...
`
    ...
    private updateCodeIndexStatusSubscription(): void {
        ...
        if (currentManager) {
            ...
            // kilocode_change: Always add subscription to webviewDisposables to prevent memory leaks
            // even if view doesn't exist yet, as it will be created later

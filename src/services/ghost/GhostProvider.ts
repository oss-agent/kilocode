...
export class GhostProvider {
    ...
    // Track disposables for proper cleanup
    ...
    private constructor(context: vscode.ExtensionContext, cline: ClineProvider) {
        ...
        // Register document event handlers and track them for disposal
        ...
        // Also add to context.subscriptions for extension-level cleanup
     ...
     */
    public dispose(): void {
        console.log("[GhostProvider] Starting disposal")
        ...
        this.disposables = []
        console.log("[GhostProvider] Disposed event listeners")

        GhostProvider.instance = null // Reset singleton
        console.log("[GhostProvider] Disposal complete")
    }
}

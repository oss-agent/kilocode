...
export class CacheManager implements ICacheManager {
    ...
    /**
     * Disposes the cache manager and cancels any pending operations
     */
    dispose(): void {
        // Cancel any pending debounced save to prevent timer leaks
        ;(this._debouncedSaveCache as any).cancel()
    }
}
